                ...
                #     mode = 'Cruising'
                    ...
                    if sig_state == 'red': # vehicle stop during red light
                        ...
                        a_instant, instant_desired_speed = IDM4LeadVehicleOrRedLight(vehicle_current_speed,
                                                                                    orginal_desire_spd, acc_speed_base,
...
def gen_desired_spd(example_coasting_profile, A, B, C, M, orginal_desire_spd, next_movement, vehicle_current_speed, current_acceleration, simsec, downstream_int_id, distance2stopbar,
                    acc_speed_base, acc_dist, num_through_lanes, upstream_flow_rate, upstream_flow_speed, SigState, 
                    t1s, t1e, t2s, t2e, r1s, distance2stopbar_next, t21s, t21e, t22s, t22e):
    """
    :param int_id_list:
    :param orginal_desire_spd:
    :param vehicle_current_speed:
    :param simsec:
    :param next_movement:
    :param downstream_int_id:
    :param distance2stopbar:
    :param adaptive_cruise_control:
    ...
    if next_movement == 'TH' and downstream_int_id in [1, 2, 3, 4, 5, 6, 7, 8]:
    ...
    return float(instant_desired_speed), mode, desired_speed, minimum_desired_speed
